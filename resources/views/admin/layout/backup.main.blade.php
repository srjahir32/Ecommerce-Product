                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control form_field" placeholder="Enter Name" id="merchant_name"
        ...
        $.ajax({
            ...
            success: function(res) {
                ...
                if ((res['merchant_name'] == null || res['merchant_name'] == '') && (res[
                    ...
                    $('.payment_payfull_option_box').click(function() {
                    $("#status").html(
