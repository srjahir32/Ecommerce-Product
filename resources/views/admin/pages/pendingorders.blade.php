            ...
            <div class="modal-content">
                <div class="modal-body viewOrderModal_body">
                    <div class="row">
                        <div class="col-md-2 back_btn_txt">
                            <a class="back_btn_link" href="" data-dismiss="modal" aria-label="Close"><img
                                    class="back_btn_img" src="{{ asset('admin/assets/img/orders/back-arrow.svg') }}" alt="">
                                <span>Back</span></a>
                        </div>
                        <div class="col-md-5">
                    ...
                    <div class="row view_product_name view_pending_order_detail">
                        <p class="big col-sm-6"><img src="{{ asset('admin/assets/img/orders/invoice_med.svg') }}" alt="">Order Details
                        </p>
            ...
            <div class="modal-content">
                <div class="modal-body customerDetailModal_body">
                    ...
                    <div class="row customer_details_content">
                        <div class="col-md-6">
                            <img class="customer_image" src="{{ asset('admin/assets/img/orders/person-icon.svg') }}" alt="">
                        </div>
                        <div class="col-md-6">
                            <div class="row">
