                ...
                <tr>
                  ...
                  >
                    <h2 class="o_heading o_mb-xxs">
                      <singleline label="Title">Your New Product</singleline>
                    </h2>
                    <multiline label="Content">
                      <p class="o_mb-md">
                        In much darn much oh informal gosh wow one much
                      </p>
                    </multiline>
                    <table
                      align="center"
                    ...
                    >
                      <tbody>
                        <tr>
                          <td
                            width="300"
                            class="o_btn o_bg-white o_br o_heading o_text"
                            align="center"
                          >
                            <a
              ...
              <td class="o_bg-light o_px-xs" align="center">
                ...
                >
                  <tbody >
                    <tr>
                      <td
                        class="o_re o_bg_gray o_px o_pt-xs o_hide-xs"
                        align="center"
                      >
                        ...
                        <div class="o_col o_col-1">
                          <div class="o_px-xs o_sans o_text-xs o_right">
                            <p class="o_text-light">
                              <singleline label="Content">Views</singleline>
                            </p>
                          </div>
                        </div>
            ...
            <tr>
              <td class="o_bg-light o_px-xs" align="center">
                ...
                >
                  <tbody>
                    <tr>
                      <td class="o_re o_bg_gray o_px o_pt" align="center">
                        <!--[if mso]><table cellspacing="0" cellpadding="0" border="0" role="presentation"><tbody><tr><td width="400" align="left" valign="top" style="padding: 0px 8px;"><![endif]-->
                          ...
                          <div class="o_px-xs o_sans o_text o_left">
                            <p class="o_text-secondary">
                              <a
                                class="o_text-primary"
                                href="{{ url('product') }}"
                                ><singleline label="Title">{{$title}}</singleline></a
                              >
                            </p>
                          </div>
                        </div>
                          ...
                          <div class="o_px-xs o_sans o_text o_center o_xs-left">
                            <p class="o_text-secondary">
                              <singleline label="Likes"
                                ><span class="o_hide-lg">Likes:&nbsp; </span
                          ...
                          <div class="o_px-xs o_sans o_text o_right o_xs-left">
                            <p class="o_text-secondary">
                              <singleline label="Views"
                                ><span class="o_hide-lg">Views:&nbsp; </span
                                >3,214</singleline
                              >
                            </p>
                          </div>
                  ...
                  >
                    <multiline label="Content">
                      <p style="margin-top: 2rem;" class="o_mb-xs">
                        ©2020 <span style="color:#a0a3ab !important;">sanalpos.co</span><br />
                      </p>
                    </multiline>
                  </td>
                </tr>
