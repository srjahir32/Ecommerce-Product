          ...
          <td class="o_bg-light o_px-xs o_pt-lg o_xs-pt-xs" align="center">
            ...
            >
              <tbody>
                <tr>
                  <td
                    class="o_bg-dark o_px o_py-md o_br-t o_sans o_text"
                    align="center"
                  >
                  ...
                  >
                    <h2 class="o_heading o_mb-xxs">
                      <singleline label="Title"
                        >Forgot Your Password?</singleline
                      >
                    </h2>
                    <multiline label="Content">
                      <p class="o_mb-md">
                        Ocelot flamingo to cut placidly darn oriole wolf hugged
                        this saw amiably opposite from before intolerably frog.
                      </p>
                    </multiline>
                    <table
                      align="center"
                      ...
                      <tbody>
                        <tr>
                          <td
                            ...
                            align="center"
                          >
                            <a style="color:#fff !important;" class="o_text-white" href="{{url('resetpassword')}}/{{$token}}"
                              ><singleline label="Button" style="color:#fff !important;"
                                >Reset My Password</singleline
                              ></a
                            >
                          </td>
                        </tr>
