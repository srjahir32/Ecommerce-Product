                    ...
                    <div class="o_col o_col-2">
                      ...
                      <div class="o_px-xs o_sans o_text o_left o_xs-center">
                        <p class="o_text-primary o_link">
                          <img
                            editable
                            src="{{ url('admin/assets/img/logo.png') }}"
                            width="136"
                            height="36"
                            alt="SimpleApp"
                ...
                <tr>
                  ...
                  >
                    <h2 class="o_heading o_mb-xxs">
                      <singleline label="Title">New Password</singleline>
                    </h2>
                    <multiline label="Content">
                      <p>That thus much less heron other hello</p>
                    </multiline>
                  </td>
                </tr>
              </tbody>
                        ...
                        >
                          <tbody>
                            <tr>
                              <td
                                width="384"
                                class="o_bg-ultra_light o_br o_text-md o_sans o_px-xs o_py-md"
                                align="center"
                              >
                                <p class="o_text-dark">
                                  <strong
