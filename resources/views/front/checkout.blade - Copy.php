        ...
        <div class="row checkout_form_box">
            ...
            <div class="col-lg-7 checkout_part_1">
                ...
                <input type="hidden" id="user_id" name="user_id" value="{{$cartproduct[0]['user_id']}}">
                    ...
                    <h2 id="p_price">₺<span>{{$cartproduct[0]['price']}}</span></h2>
                    ...
                    <div>
                        ...
                        <span><input type="text" id="p_quantity" name="p_quantity" max="{{$cartproduct[0]['order_limit']}}" value="1" disabled /></span>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <img src="{{ asset('products/image/').'/'.$productimg[0]['image_path'] }}" alt=""
                                            class="itme_img">
                                    @endif
                                        <span class="item_name">{{$cartproduct[0]['product_name']}}</span>
                                    </td>
                                    <td >₺{{$cartproduct[0]['price']}}</td>
                                ...
                                <tr>
                                    ...
                                    @else
                                        <img src="{{ asset('products/image/').'/'.$productimg[0]['image_path'] }}" alt=""
                                            class="itme_img">
                                    @endif
                                        <span class="item_name"  id="product_name">{{$cartproduct[0]['product_name']}}</span>
                                    </td>
                                    <td >₺<span id="product_price">{{$cartproduct[0]['price']}}</span></td>
            ...
            <div class="col-lg-5 checkout_part_2">
                <form id="msform">
                    ...
                    <fieldset id="check_form_2">
                        ...
                        <input type="button" name="next" class="btn next2 action-button next_btn" value="Next" />
                    </fieldset>
                    <!-- form 3 fieldsets -->
...
$(".submit").click(function () {
    ...
    $.ajax({
            ...
            type: 'POST',
            url: "{{ url('orderdata') }}",
            data: $('#msform').serialize()+ "&product_name=" + product_name+ "&product_price=" + product_price + "&cart_item=" + cart_item + "&product_total_price=" + product_total_price + "&product_id=" + product_id + "&user_id=" + user_id,
