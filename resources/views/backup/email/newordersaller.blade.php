...
<html lang="en">
  <head>
    ...
    <style type="text/css">
      ...
      .approve-button {
        ...
        color: rgb(58, 118, 246) !important;
      }
      .decline-button {
        background: rgb(216, 108, 46) !important;
      }
    </style>
    <!--[if mso]>
      <style>
  ...
  <body class="o_body o_bg-light">
          ...
          <td class="o_bg-light o_px-xs o_pt-lg o_xs-pt-xs" align="center">
            ...
            >
              <tbody>
                <tr>
                  <td
                    class="o_re o_bg-primary o_px o_pb-md o_br-t"
                    align="start"
                  >
                  ...
                  >
                    <h2 class="o_heading o_mb-xxs">
                      <singleline label="Title"
                        >New sale for {{$item}}</singleline
                      >
                    </h2>
                    <multiline label="Content">
                      <p class="o_mb-md">
                        Review and manage this order in your dashboard or by
                        clicking the order management buttons below. The invoice
                        is issued only if you approve it.
                      </p>
                    </multiline>

                    <div>
                      <a
                        class="o_text-primary approve-button"
                        href="{{ url('pending-orders') }}"
                        ><singleline label="Button"
                          >Approve Order</singleline
                        ></a
                      >
                      <a
                        class="o_text-primary decline-button"
                        href="{{ url('pending-orders') }}"
                        ><singleline label="Button"
                          >Decline Order</singleline
                        ></a
                      >
                    </div>
                  </td>
              ...
              <td class="o_bg-light o_px-xs" align="center">
                ...
                >
                  <tbody>
                    <tr>
                      <td
                        class="o_bg-white o_sans o_text-xs o_text-light o_px-md o_pt-xs"
                        align="center"
                      >
                        <p>
                          <singleline label="Content"
                            >Billing Information</singleline
                          >
                        </p>
                        <table
                          width="100%"
                        ...
                        >
                          <tbody>
                            <tr>
                              <td style="font-weight: 600;">{{$customer_name}}</td>
                            </tr>
                            <tr>
                              <td>
                              {{$address}}
              ...
              <td class="o_bg-light o_px-xs" align="center">
                ...
                >
                  <tbody>
                    <tr>
                      <td
                        class="o_re o_bg-white o_px o_pt-xs o_hide-xs"
                        align="center"
                      >
                        ...
                        <div class="o_col o_col-1">
                          <div class="o_px-xs o_sans o_text-xs o_center">
                            <p class="o_text-light">
                              <singleline label="Content">Quantity</singleline>
                            </p>
                          </div>
                        </div>
                        ...
                        <div class="o_col o_col-1">
                          <div class="o_px-xs o_sans o_text-xs o_right">
                            <p class="o_text-light">
                              <singleline label="Content">Price</singleline>
                            </p>
                          </div>
                        </div>
                    ...
                    <tr>
                      <td class="o_re o_bg-white o_px o_pt" align="center">
                        ...
                        <div class="o_col o_col-4 o_col-full">
                          <div class="o_px-xs o_sans o_text o_left">
                        ...
                        <div class="o_col o_col-1 o_col-full">
                          <div class="o_px-xs o_sans o_text o_center o_xs-left">
                            <p class="o_text-secondary">
                              <singleline label="Likes"
                                ><span class="o_hide-lg"> </span>{{$quantity}}</singleline
                              >
                            </p>
                          </div>
                        </div>
                        ...
                        <div class="o_col o_col-1 o_col-full">
                          <div class="o_px-xs o_sans o_text o_right o_xs-left">
                            <p class="o_text-secondary">
                              <singleline label="Views"
                                ><span class="o_hide-lg"></span
                                >{{$currency}}{{$price}}</singleline
                              >
                            </p>
                          </div>
                        </div>
          ...
          <td class="o_bg-light o_px-xs o_pb-lg o_xs-pb-xs" align="center">
            ...
            >
              <tbody>
                <tr>
                  <td
                    class="o_bg-dark o_px-md o_pb-lg o_br-b o_sans o_text-xs o_text-dark_light"
                    align="center"
                  >
                    <multiline label="Content">
                      <p style="margin-top: 2rem;" class="o_mb-xs">
                        ©2020 sanalpos.co<br />
                      </p>
                    </multiline>
                  </td>
    ...
    <div class="o_hide"><unsubscribe>Unsubscribe</unsubscribe></div>
  </body>
</html>
