...
<html lang="en">
  ...
  <body class="o_body o_bg-light">
    ...
    >
      <tbody>
        <tr>
          <td class=".o_bg-dark o_px-xs o_pt-lg o_xs-pt-xs" align="center">
            ...
            >
              <tbody>
                <tr>
                  <td class="o_re o_bg-dark o_px o_pb-md o_br-t" align="start">
          ...
          <td class="o_bg-light o_px-xs" align="center">
            ...
            >
              <tbody>
                <tr>
                  <td
                    class="o_bg-dark o_px-md o_py-xl o_xs-py-md o_sans o_text-md o_text-white"
                    align="center"
                  >
                    <h2 class="o_heading o_mb-xxs">
                      <singleline label="Title"
                        >Your purchase has been confirmed</singleline
                      >
                    </h2>
                    <multiline label="Content">
                      <p class="o_mb-md">
                        Your order has been received and is currently being
                        processed. You will receive updates via email once it
